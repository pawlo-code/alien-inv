...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        icon = pygame.image.load(self.settings.game_icon)
        ...
        self.easy_button.rect.y = self.easy_button.rect.y - (2 * self.easy_button.height)
        self.hard_button.rect.y = self.hard_button.rect.y + (2 * self.hard_button.height)
    ...
    def _create_fleet(self):
        alien = Alien(self)
        avaliable_space_x = self.screen.get_width()
        number_alien_x = avaliable_space_x // (2 * alien.rect.width)
    ...
    def _check_play_button(self, mouse):
        if self.play_button.rect.collidepoint(mouse) and not self.stats.game_active and not self.game_level:
            self._play_game()
        elif self.easy_button.rect.collidepoint(mouse) and self.game_level:
            self._level("easy")
        elif self.medium_button.rect.collidepoint(mouse) and self.game_level:
            self._level("medium")
        elif self.hard_button.rect.collidepoint(mouse) and self.game_level:
            self._level("hard")
